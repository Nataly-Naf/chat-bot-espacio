...
Люблю подорожі, фотографувати на плівку та спостерігати за результами моїх учнів.`
  ...
  'Катерина': {
    photo: path.join(__dirname, 'pictures', 'Kateryna.jpeg'),
    description: `Hola, amig@s!
Soy Kateryna de la hermosa ciudad de Odesa.
Я викладаю іспанську мову й закохую у неї своїх учнів,
тому що для мене іспанська стала для не просто мовою, а частиною життя.
